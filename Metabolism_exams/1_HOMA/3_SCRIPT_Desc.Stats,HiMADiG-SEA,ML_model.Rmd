...
Name_Variable_Axis_Y<-"HOMA-IR"

Unit_Measurement_Variable_Axis_Y <- ""

Test_decision_limit<-"2.7"
...
Individual_Biological_Coefficient_Variation<-""

Group_Biological_Coefficient_Variation__CVg<-""
...
desirable_performance_specifications<-""
