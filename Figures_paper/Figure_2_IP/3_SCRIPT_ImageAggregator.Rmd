...
image_filenames <- sprintf("Fig.%d.jpeg", 1:7)  # This creates "Fig.1.jpg", "Fig.2.jpg", ..., "Fig.7.jpg"
...
labeled_grobs <- mapply(add_label, image_grobs, LETTERS[1:7], SIMPLIFY = FALSE)
